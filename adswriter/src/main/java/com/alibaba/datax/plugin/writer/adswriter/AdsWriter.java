...
import net.tbsoft.datax.plugin.writer.adswriter.insert.AdsClientProxy;
import net.tbsoft.datax.plugin.writer.adswriter.insert.AdsInsertProxy;
import net.tbsoft.datax.plugin.writer.adswriter.insert.AdsInsertUtil;
import net.tbsoft.datax.plugin.writer.adswriter.insert.AdsProxy;
import net.tbsoft.datax.plugin.writer.adswriter.load.AdsHelper;
import net.tbsoft.datax.plugin.writer.adswriter.load.TableMetaHelper;
...
import net.tbsoft.datax.plugin.writer.odpswriter.OdpsWriter;
